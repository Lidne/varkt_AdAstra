...
def open_file():
    with open("/Users/bebebe/Desktop/varkt_AdAstra/data/grohot_data.txt", encoding='utf-8') as f:
...
def main():
    ...
    for t in range(1, T):
        ...
        print(
            f"x: {current_x}, y: {current_y}, vx: {current_vx}, vy: {current_vy}, d: {current_x / d}, m: {current_mass}, alt: {h}, Fc_ksp: {ksp_friction[t]}, t: {t}")
